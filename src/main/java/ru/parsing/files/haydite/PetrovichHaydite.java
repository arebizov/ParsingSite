...
public class PetrovichHaydite {
    ...
    public List<SourceData> parsData() throws IOException {
        ...
        pagesList.add("https://moscow.petrovich.ru/catalog/9576107/169324/");
        pagesList.add("https://moscow.petrovich.ru/product/151417/");
    ...
    public List<SourceData> parsing(List<String> ll) throws IOException {
        for (String url : ll) {
            try {
                ...
                Double price = Double.valueOf(priceStr.replace(" ", "")) * 20;
