...
public class McenaCrushedStone {
    ...
    public List<SourceData> parsData() throws IOException {
        ...
        pagesList.add("https://www.mcena.ru/sypuchie-materialy/shcheben/gravijnyj_dinamica");
        ...
        for (String url : ll) {
            try {
                ...
                for (int i = 0; i < rows.size(); i++) {
                    ...
                    String offers = "Лист горячекатанный " + rows.get(i).select("td").get(0).text();
