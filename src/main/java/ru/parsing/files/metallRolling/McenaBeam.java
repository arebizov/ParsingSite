...
public class McenaBeam {
    ...
    public List<SourceData> parsData() throws IOException {
        ...
        pagesList.add("https://www.mcena.ru/metalloprokat/balki/dvutavrovaya-balka/goryachekatanaya-st3-gost-8239_ceny");
        ...
        for (String url : ll) {
            try {
                ...
                for (int i = 0; i < rows.size(); i++) {
                    ...
                    String offers = "Двутавровая балка " + rows.get(i).select("td").get(0).text();
