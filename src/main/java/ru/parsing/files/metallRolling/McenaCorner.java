...
public class McenaCorner {
    ...
    public List<SourceData> parsData() throws IOException {
        ...
        pagesList.add("https://www.mcena.ru/metalloprokat/ugolok/ravnopolochnyj-gost-8509_ceny");
        ...
        for (String url : ll) {
            try {
                ...
                for (int i = 0; i < rows.size(); i++) {
                    ...
                    String offers = "Уголок равнополочный " + rows.get(i).select("td").get(0).text();
