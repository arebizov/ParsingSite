...
public class McenaChannel {
    ...
    public List<SourceData> parsData() throws IOException {
        ...
        pagesList.add("https://www.mcena.ru/metalloprokat/shveller/shveller-p_ceny");
        ...
        for (String url : ll) {
            try {
                ...
                for (int i = 0; i < rows.size(); i++) {
                    ...
                    String offers = "Швеллер горячекатанный " + rows.get(i).select("td").get(0).text();
